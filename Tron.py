...
def how_to_play():
    ...
    while True:
        ...
        #Text
        message_display("Do not Touch Yourself, Or you Die",25,2,2,text_objects)
        message_display("Do not Touch Your Opponent, Or you Die",25,2,1.7,text_objects)
        message_display("You Move with Arrow Keys, WASD and the Joysticks",25,2,1.5,text_objects)
